...
describe 'TagAnnotationRDF' do
  # it_behaves_like 'an ActiveTriple::Resource'

  subject { RDFTypes::TagAnnotationRDF.new }  # new virtual collection without a subject
  ...
  describe 'rdf_subject' do
    ...
    it "should append to base URI when setting to non-URI subject" do
      ...
      expect(subject.rdf_subject).to eq RDF::URI("#{RDFTypes::TagAnnotationRDF.base_uri}/#{RDFTypes::TagAnnotationRDF.id_prefix}123")
    end
  ...
  describe "#persist!" do
    context "when the repository is set" do
      context "and the item is not a blank node" do
        ...
        subject {RDFTypes::TagAnnotationRDF.new("123")}
  ...
  describe '#destroy!' do
    ...
    context 'with a parent' do
      ...
      let(:parent) do
        RDFTypes::TagAnnotationRDF.new('123')
      end
  ...
  describe '#type' do
    it 'should return the type configured on the parent class' do
      expect(subject.type).to eq [RDFTypes::TagAnnotationRDF.type]
    end
  ...
  describe '#rdf_label' do
    ...
    it 'should return the default label as URI when no title property exists' do
      expect(subject.rdf_label).to eq [RDF::URI("#{RDFTypes::TagAnnotationRDF.base_uri}/#{RDFTypes::TagAnnotationRDF.id_prefix}123")]
    end
  ...
  describe 'big complex graphs' do
    before do
      ...
      RDFTypes::TagAnnotationRDF.property :item, :predicate => RDF::DC.relation, :class_name => DummyDocument
    end

    subject { RDFTypes::TagAnnotationRDF.new }
