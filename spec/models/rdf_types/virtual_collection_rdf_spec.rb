...
describe 'VirtualCollectionRDF' do
  # it_behaves_like 'an ActiveTriple::Resource'

  subject { RDFTypes::VirtualCollectionRDF.new }  # new virtual collection without a subject
  ...
  describe 'rdf_subject' do
    ...
    it "should append to base URI when setting to non-URI subject" do
      ...
      expect(subject.rdf_subject).to eq RDF::URI("#{RDFTypes::VirtualCollectionRDF.base_uri}/#{RDFTypes::VirtualCollectionRDF.id_prefix}123")
    end
  ...
  describe "#persist!" do
    context "when the repository is set" do
      context "and the item is not a blank node" do
        ...
        subject {RDFTypes::VirtualCollectionRDF.new("123")}
  ...
  describe '#destroy!' do
    ...
    context 'with a parent' do
      ...
      let(:parent) do
        RDFTypes::VirtualCollectionRDF.new('123')
      end
  ...
  describe 'attributes' do
    ...
    let(:owner) { RDFTypes::PersonRDF.new('456') }
  ...
  describe 'child nodes' do
    it 'should return an object of the correct class when the value is built from the base URI' do
      subject.owner = RDFTypes::PersonRDF.new('456')
      expect(subject.owner.first).to be_kind_of RDFTypes::PersonRDF
    end

    it 'should return an object with the correct URI created with a URI' do
      subject.owner = RDFTypes::PersonRDF.new("http://vivo.cornell.edu/individual/JohnSmith")
    ...
    it 'should return an object of the correct class when the value is a bnode' do
      subject.owner = RDFTypes::PersonRDF.new
      expect(subject.owner.first).to be_kind_of RDFTypes::PersonRDF
    end
  end
  ...
  describe '#type' do
    it 'should return the type configured on the parent class' do
      expect(subject.type).to eq [RDFTypes::VirtualCollectionRDF.type]
    end
  ...
  describe 'big complex graphs' do
    before do
      ...
      RDFTypes::VirtualCollectionRDF.property :item, :predicate => RDF::DC.relation, :class_name => DummyDocument
    end
